...
public class AdminDaoService extends AbstractDaoService implements AdminRepository {
    ...
    public boolean addAdmin(AddAdmin admin) {
        ...
        String sql = "INSERT INTO admins VALUES(DEFAULT, :userId, :degree, :roledescr);";
    ...
    @Override
    public boolean updateAdmin(UpdateAdmin admin) {
    ...
    public GetAdmin getAdminById(UUID adminId) {
        ...
        try (Connection connection = daoFactory.getDataSource().open()) {
            ...
            GetAdmin admin = connection.createQuery(sql, false)
                    .addParameter("id", adminId)
                    .executeAndFetchFirst(GetAdmin.class);
    ...
    public List<GetAdmin> getAllAdmins() {
        ...
        try (Connection connection = daoFactory.getDataSource().open()) {
            ...
            List<GetAdmin> admin = connection.createQuery(sql, false)
                    .executeAndFetch(GetAdmin.class);
